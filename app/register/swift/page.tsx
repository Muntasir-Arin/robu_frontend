...
const steps = [
  {
    ...
    fields: ['name', 'date_of_birth', 'email', 'secondary_email', 'phone_number', 'department', 'avatar', 'rs_status', 'facebook_profile', 'bracu_start', 'gender', 'blood_group']
  },
  {
    id: 'Step 2',
  ...
  { id: 'Step 3', name: 'Account Details' ,
  fields: ['country', 'state', 'city', 'street', 'zip']}
]
